...
public final class Constants {
    ...
    public static final class TurretConstants {
        ...
        // Slot 0: PositionVoltage go-to-angle (hold, forward, sweep)
        // Slot 1: PositionVoltage tracking (auto-track CAMERA, manual align)
        public static final double kTurretP = 5.0;     // was 18 without planetary (slot 0)
        ...
        // With 4:1 planetary, the error in motor rotations is 4× larger, so kP
        // should be ~4× lower for equivalent turret-level response.
        // Old: kP=40 at 11.11:1. New: kP=10 at 44.44:1 (same effective gain).
        // Start at 10, tune up to 20 if tracking is too slow, down to 5 if buzzy.
        public static final double kTurretTrackingP = 10.0;  // was 40 without planetary
    ...
    public static final class TurretTrackingConstants {
        ...
        public static final double kTrackingToleranceDeg = 2.5;  // simulation-optimized — below 2° chases camera noise
        ...
        public static final double kCameraTrackingGain = 0.80;  // simulation-optimized — 80% converges in 1-2 frames
        ...
        public static final double kConvergeTimeSec = 0.15;  // simulation-optimized — gentler FF prevents backlash overshoot
        ...
        public static final int kTrackingDebounceFrames = 0;  // simulation-optimized — EWMA gain 0.80 already filters noise
